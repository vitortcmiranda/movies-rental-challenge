...
This project is configured for GitHub Codespaces, which allows you to work on the project in a fully configured, remote development environment. Feel free to use this feature and create a new Codespace for your forked repository to make the task execution easier.
